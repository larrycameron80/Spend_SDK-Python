...
def usersignup(username,password,firstName,lastName,country,address,city,state,zipcode,nin,email,phone,birthdate):
        endpoint="/user/signup"
        rpc_input ={"username":username,"password":password,"firstName":firstName,"lastName":lastName,"country":country,"address":address,"city":city,"state":state,'zipcode':zipcode,"nin":nin,"email":email,"phone":phone,"birthdate":birthdate,"overrideConfirmation":"True"}
